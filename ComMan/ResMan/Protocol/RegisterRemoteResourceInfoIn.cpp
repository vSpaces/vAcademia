...
CRegisterRemoteResourceInfoIn::CRegisterRemoteResourceInfoIn(BYTE *aData, int aDataSize) : CCommonPacketIn(aData, aDataSize){
}

bool CRegisterRemoteResourceInfoIn::GetInfo(CResInfoSaver *resInfoSaver, bool bGetData)
{
	if(bGetData){
		idx = indexFirstFile;
	}
...
bool CRegisterRemoteResourceInfoIn::Analyse()
{
...
int CRegisterRemoteResourceInfoIn::GetStatus(){
	return iStatus;
}
