...
CPackUpdateClientFilesAndGetInfoIn::CPackUpdateClientFilesAndGetInfoIn(BYTE *aData, int aDataSize) : CCommonPacketIn(aData, aDataSize){
}

bool CPackUpdateClientFilesAndGetInfoIn::GetInfo(CResInfoSaver *resInfoSaver, bool bGetData)
{
	if(bGetData){
		idx = indexFirstFile;
	}
...
bool CPackUpdateClientFilesAndGetInfoIn::Analyse()
{
...
int CPackUpdateClientFilesAndGetInfoIn::GetStatus(){
	return iStatus;
}
