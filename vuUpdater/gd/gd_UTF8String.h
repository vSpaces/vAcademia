...
public:
   ...
   void Insert( unsigned uPosition, const TCHAR* pszText, unsigned uRepeat = 1 );
...
public:
   ...
   //static void TCHAR_to_UTF8( const char* pbszMB, char* pbszUTF8, unsigned uMaxLength );
   //! convert unicode to UTF8
   static void TCHAR_to_UTF8( const wchar_t* pwszWC, char* pbszUTF8, unsigned uMaxLength, const wchar_t* pwszEnd = NULL );
   //! convert multibyte to UTF8
   static void TCHAR_to_UTF8( const char* pbszMB, char* pbszUTF8, unsigned uMaxLength, const char* pbszEnd = NULL );
   //! convert UTF8 to unicode
   static HRESULT UTF8_to_TCHAR( const char* pbszUTF8, wchar_t* pwszWC, unsigned uMaxLength, unsigned* puCount, char const** ppbszEnd );
   //! convert UTF8 to multibyte
   static HRESULT UTF8_to_TCHAR( const char* pbszUTF8, char* pbszMB, unsigned uMaxLength, unsigned* puCount, char const** ppbszEnd );
...
inline unsigned CUTF8String::GetLength() {
   return m_pData->GetLength(); }

inline char* CUTF8String::GetUTF8Text() {
   return m_pData->GetText(); }

inline int CUTF8String::Find( char chCharacter ) const {
   TCHAR pszText[2]; pszText[0] = chCharacter; pszText[1] = 0;
   return Find( pszText, 0 );
}

inline int CUTF8String::Find( char chCharacter, unsigned uStart ) const {
   TCHAR pszText[2]; pszText[0] = chCharacter; pszText[1] = 0;
   return Find( pszText, uStart );
}

inline int CUTF8String::Find( const char* pszText ) const {
   return Find( pszText, 0 );
}

#ifdef _WCHAR_T_DEFINED
inline int CUTF8String::Find( wchar_t chCharacter ) const {
   wchar_t pszText[2]; pszText[0] = chCharacter; pszText[1] = 0;
   return Find( pszText, 0 );
}

inline int CUTF8String::Find( wchar_t chCharacter, unsigned uStart ) const {
   wchar_t pszText[2]; pszText[0] = chCharacter; pszText[1] = 0;
   return Find( pszText, uStart );
}

inline int CUTF8String::Find( const wchar_t* pszText ) const {
   return Find( pszText, 0 );
}
#else
inline int CUTF8String::Find( unsigned short chCharacter ) const {
   unsigned short pszText[2]; pszText[0] = chCharacter; pszText[1] = 0;
   return Find( pszText, 0 );
}

inline int CUTF8String::Find( unsigned short chCharacter, unsigned uStart ) const {
   unsigned short pszText[2]; pszText[0] = chCharacter; pszText[1] = 0;
   return Find( pszText, uStart );
}

inline int CUTF8String::Find( const unsigned short* pszText ) const {
   return Find( pszText, 0 );
}
#endif

inline bool operator==( const CUTF8String& s, const char* pbszText ) {
   return s.operator==( CUTF8String( pbszText ) ); }
inline bool operator==( const char* pbszText, const CUTF8String& s ) {
   return s.operator==( CUTF8String( pbszText ) ); }
...
#ifdef _WCHAR_T_DEFINED
inline bool operator==( const CUTF8String& s, const wchar_t* pbszText ) {
   return s.operator==( CUTF8String( pbszText ) ); }
inline bool operator==( const wchar_t* pbszText, const CUTF8String& s ) {
   return s.operator==( CUTF8String( pbszText ) ); }
...
inline bool operator!=( const wchar_t* pbszText, const CUTF8String& s ) {
   return !(s.operator==( CUTF8String( pbszText ) )); }
#else
inline bool operator==( const CUTF8String& s, const unsigned short* pbszText ) {
   return s.operator==( CUTF8String( pbszText ) ); }
inline bool operator==( const unsigned short* pbszText, const CUTF8String& s ) {
   return s.operator==( CUTF8String( pbszText ) ); }
...
inline CUTF8String operator+( CUTF8String& s, char* pbszText ) {
   CUTF8String sR( s ); sR.Add( pbszText ); return sR; }
#ifdef _WCHAR_T_DEFINED
inline CUTF8String operator+( CUTF8String& s, wchar_t* pwszText ) {
#else
inline CUTF8String operator+( CUTF8String& s, unsigned short* pwszText ) {
#endif
