              ...
              void *ptr)
{
    ...
    if (count == capacity) {
        ...
        array = (void **) js_reallocMP(table->array,
               ...
               size_t newCount)
{
    ...
    if (oldCapacity != capacity) {
        ...
        array = (void **) js_reallocMP(array, capacity * sizeof array[0]);
        if (array)
            table->array = array;
    }
#ifdef DEBUG
...
# endif
     ...
     */
    p = js_mallocMP((js_gcArenasPerChunk + 1) << GC_ARENA_SHIFT);
    if (!p)
        return 0;
