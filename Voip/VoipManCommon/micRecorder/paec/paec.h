 ...
 *
 * $Log: paec.h,v $
 * Revision 1.1  2009/10/22 07:44:17  Vladimir
 * no message
 *
 * Revision 1.1.2.1  2009/10/20 13:59:52  Vladimir
 * no message
 *
 * Revision 1.2  2008/12/05 14:08:12  Percei
 * no message
 *
...
protected:
  ...
  //PTimeInterval lastTimeStamp;        // LastTimeStamp of received data
  BOOL receiveReady;
  void *ref_buf;
  void *echo_buf;
  void *e_buf;
