...
CGetInputDevicesResultIn::CGetInputDevicesResultIn(BYTE *aData, int aDataSize) : 
		CCommonPipePacketIn(aData, aDataSize)
		,MP_VECTOR_INIT(inputDevicesInfo)
{
}

bool CGetInputDevicesResultIn::Analyse()
{
...
vecDeviceInfo *CGetInputDevicesResultIn::GetInputDevicesInfo()
{
