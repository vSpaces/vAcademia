...
static const char qt_meta_stringdata_ConfigWidget[] = {
    "ConfigWidget\0\0intSignal(int)\0accept()\0"
    "save()\0r\0load(Settings)\0bool\0expert(bool)\0"
};
...
int ConfigWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: accept(); break;
        case 2: save(); break;
        case 3: load((*reinterpret_cast< const Settings(*)>(_a[1]))); break;
        case 4: { bool _r = expert((*reinterpret_cast< bool(*)>(_a[1])));
