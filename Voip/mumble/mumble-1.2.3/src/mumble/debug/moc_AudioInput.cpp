...
static const char qt_meta_stringdata_AudioInput[] = {
    "AudioInput\0\0doDeaf()\0"
};

const QMetaObject AudioInput::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_AudioInput,
      qt_meta_data_AudioInput, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AudioInput::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AudioInput))
