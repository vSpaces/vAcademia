...
void protobuf_AssignDesc_Mumble_2eproto() {
  ...
  static const int UserList_User_offsets_[2] = {
...
void protobuf_AddDesc_Mumble_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "description\030\003 \003(\rB\002H\001", 4341);
...
const Version& Version::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_Mumble_2eproto();  return *default_instance_;
}
      ...
      case 3: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_tokens:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->tokens(0).data(), this->tokens(0).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
