...
class VA_RTL_API CComString  
{
public: 
	void CreateString( LPCSTR aStrData, int aDataLen);
	//void ReleaseBuffer(int count = -1);
	LPTSTR GetBuffer(int count = -1);
	CComString();
	CComString(const CComString& str);
	CComString(LPCSTR pszString);
	CComString(BSTR bstrString);
	CComString(const wchar_t *bstrString);
	...
	friend VA_RTL_API CComString operator+(CComString& strSrc1, CComString& strSrc2);
	friend VA_RTL_API CComString operator+(CComString& strSrc, BSTR bstrStr);
	friend VA_RTL_API CComString operator+(const CComString& strSrc1, const CComString& strSrc2);
	friend VA_RTL_API CComString operator+(BSTR bstrStr, CComString& strSrc);
