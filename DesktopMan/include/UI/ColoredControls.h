...
public:
   ...
   BEGIN_MSG_MAP(CColoredStaticImpl)
	  ...
	  MESSAGE_HANDLER(OCM_CTLCOLORBTN, OnCtlColorBtn)
...
class CColoredTrackBarCtrl : public CColoredStaticImpl<CColoredTrackBarCtrl, CTrackBarCtrl>
{
public:
	DECLARE_WND_SUPERCLASS(_T("WTL_ColoredTrackbar"), GetWndClassName())  
};

class CColoredScrollBarCtrl : public CColoredStaticImpl<CColoredScrollBarCtrl, CScrollBar>
{
public:
	DECLARE_WND_SUPERCLASS(_T("WTL_ColoredScrollbar"), GetWndClassName())  
};

class CColoredGroupBoxCtrl : public CColoredStaticImpl<CColoredGroupBoxCtrl, CButton>
{
public:
	DECLARE_WND_SUPERCLASS(_T("WTL_ColoredGroupbox"), GetWndClassName())  
};
...
public:
   ...
   LRESULT OnDrawItem(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL& /*bHandled*/)
   {
	  ...
	  // Draw boundary rectangle
	  {
		  ...
		  dc.RoundRect(&rc, CPoint(roundFactor, roundFactor));
