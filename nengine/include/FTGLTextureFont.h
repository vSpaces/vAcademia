...
class  FTGL_EXPORT FTGLTextureFont : public FTFont
{
    public:
         ...
         */
        FTGLTextureFont( const char* fontFilePath, bool antiliased = false);
         ...
         */
        virtual void Render( const char* string, IPolygonsAccum* accum);
         ...
         */
        virtual void Render( const wchar_t* string, IPolygonsAccum* accum);

		int GetFontTextureID();
    ...
    protected:
         ...
         */
        inline virtual FTGlyph* MakeGlyph( unsigned int glyphIndex, unsigned int realCode=0);
