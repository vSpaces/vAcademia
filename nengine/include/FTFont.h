...
class FTGL_EXPORT FTFont
{
    public:
		...
		void GetSmallAlphabetY(float& y1, float& y2);
         ...
         */
        virtual void Render( const char* string, IPolygonsAccum* accum = NULL );
         ...
         */
        virtual void Render( const wchar_t* string, IPolygonsAccum* accum = NULL );
    ...
    protected:
         ...
         */
        virtual FTGlyph* MakeGlyph( unsigned int g, unsigned int realCode=0) = 0;
