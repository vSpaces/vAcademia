...
//
//=================================================================================================================================
// $Id: tootlelib.h,v 1.1.1.1 2008/12/12 12:40:18 ango Exp $ 
//
// Last check-in:  $DateTime: 2008/03/21 17:15:20 $ 
// Last edited by: $Author: ango $
//=================================================================================================================================
...
/// \param pIBOut            A pointer that will be filled with an optimized index buffer.  May be NULL.  May equal pIB
...
/// 
/// \param pnIB             The input index buffer: 3 unsigned int per triangle, it has to be in CCW order.
...
///                            of total clusters.
/// \param pnIBOut            An array that will receive the re-ordered index buffer.  May be NULL.  May equal pIB
...
/// \param pnIBOut          A pointer that will be filled with an optimized index buffer.  May be NULL.  May equal pIB
/// \param pnFaceRemapOut   A pointer to an array that will be filled with a face re-mapping.  May be NULL.  This is an array of 
///                          nFaces elements.  
///                          Element i in the array will contain the position of input face i in the output face ordering.
/// \param eVCacheOptimizer The selection for choosing the algorithm to optimize vertex cache.  There are four choices:
...
/// \param nVBStride            The distance between successive vertices in the vertex buffer, in bytes.  This must be at least 
///                              3*sizeof(float).
/// \param pVBOut               The output vertex buffer. May not be NULL.  May equal to pVB.
/// \param pnIBOut              The output index buffer.  May not be NULL.  May equal to pIB. 
