...
//***************************************************************************
BOOL
SECFileSystem::GetFileStatus(const CString& FileName, CFileStatus& FileStatus)
{
...
//***************************************************************************
BOOL
SECFileSystem::GetFileCreateTime(const CString& FileName, CTime& time)
{
...
//***************************************************************************
BOOL
SECFileSystem::GetFileModifyTime(const CString& FileName, CTime& time)
{
  CFileStatus FileStatus;
  if (CFile::GetStatus(FileName, FileStatus))
  {
...
//***************************************************************************
BOOL
SECFileSystem::GetFileAccessTime(const CString& FileName, CTime& time)
{
  CFileStatus FileStatus;
  if (CFile::GetStatus(FileName, FileStatus))
  {
...
//***************************************************************************
BOOL
SECFileSystem::GetFileSize(const CString& FileName, unsigned long& lSize)
{
  CFileStatus FileStatus;
  if (CFile::GetStatus(FileName, FileStatus))
  {
...
//***************************************************************************
BOOL
SECFileSystem::GetFileAttribute(const CString& FileName, BYTE& nAttribute)
{
  CFileStatus FileStatus;
  if (CFile::GetStatus(FileName, FileStatus))
  {
...
//***************************************************************************
BOOL
SECFileSystem::GetADirectoryEntry(CString &fileName, const CString& Wildcard /* = "" */, const unsigned long eFileAttrib /* = normal */)
{
  BOOL      bRetVal = TRUE;
  DWORD		tmp;
...
//***************************************************************************
CString *
SECFileSystem::GetDirectoryEntry(const CString& Wildcard /* = "" */, const unsigned long eFileAttrib /* = normal */)
{
#ifdef WIN32
...
//***************************************************************************
CString
SECFileSystem::GetCurrentDirectory(const CString& FileSystem /* = "" */)
{
  // Turn off DOS critical error handler.
...
//***************************************************************************
BOOL
SECFileSystem::ChangeDirectory(const CString& NewDirectory)
{
...
//***************************************************************************
BOOL
SECFileSystem::RenameDirectory(const CString& OldName, const CString& NewName)
{
  if (OldName == NewName)
  {
    return TRUE;
...
//***************************************************************************
BOOL
SECFileSystem::MakeDirectory(const CString& NewDirectory)
{
#ifdef WIN32
...
//***************************************************************************
BOOL
SECFileSystem::MakePath(const CString& NewDirectory)
{
...
//***************************************************************************
BOOL
SECFileSystem::DeleteDirectory(const CString& Directory, const BOOL bDeleteFilesAndDirs /* = FALSE */)
{
...
//***************************************************************************
LONG
SECFileSystem::GetDirectorySize(const CString& Directory /* = "" */, const CString& WildCard /* = "*.*" */, const BOOL bRecurseSubdirs /* = FALSE */)
{
  LONG lSize = 0;
...
//***************************************************************************
BOOL
SECFileSystem::ChangeFileSystem(const CString& FileSystem)
{
#ifdef WIN32
...
//***************************************************************************
CString
SECFileSystem::GetVolumeLabel(const CString& FileSystem)
{
  ::SetErrorMode(SEM_FAILCRITICALERRORS);
...
//***************************************************************************
LONG
SECFileSystem::GetFileSystemType(const CString& FileSystem)
{
...
//***************************************************************************
LONG
SECFileSystem::GetFreeSpace(const CString& FileSystem)
{
#ifdef WIN32
...
//***************************************************************************
LONG
SECFileSystem::GetTotalSpace(const CString& FileSystem)
{
#ifdef WIN32
...
//***************************************************************************
BOOL
SECFileSystem::IsReadOnlyFileSystem(const CString& FileSystem)
{
  BOOL            bRetVal = TRUE;
  CFile           TestFile;
...
//***************************************************************************
BOOL
SECFileSystem::RenameFile(const CString& OldFileName, const CString& NewFileName)
{
...
//***************************************************************************
BOOL
SECFileSystem::DeleteFiles(const CString& FileSpec, const unsigned long eFileAttrib /* = normal */)
{
  BOOL bRetVal = TRUE;
...
//***************************************************************************
BOOL
SECFileSystem::DeleteFile(const CString& FileName)
{
  TRY
  {
...
//***************************************************************************
BOOL
SECFileSystem::CopyFile(const CString& SourceFileName, const CString& DestFileName, const unsigned long lBuffSize /* = 10240 */)
{
  BOOL    bRetVal  = TRUE;
...
//***************************************************************************
BOOL
SECFileSystem::CopyFiles(const CString& FileSpec, const CString& DestPath, const BOOL bIgnoreErrors /* = FALSE */, const unsigned long eFileAttrib /* = normal */)
{
  BOOL bRetVal = TRUE;
  CStringList *pDir = GetDirectory(FileSpec, eFileAttrib);
...
//***************************************************************************
BOOL
SECFileSystem::CompareFiles(const CString& FileName1, const CString& FileName2, const unsigned long lBuffSize /* = 10240 */)
{
  BOOL    bRetVal  = TRUE;
...
//***************************************************************************
BOOL
SECFileSystem::CompareDirectories(const CString& PathName1, const CString& PathName2, const BOOL bRecurseSubdirs /* = FALSE */, const BOOL bCompareFileContents /* = FALSE */, const unsigned long eFileAttrib /* = normal */)
{
  BOOL bRetVal = TRUE;
...
//***************************************************************************
CString
SECFileSystem::GetFullPathName(const CString& PathAndFileName)
{
#ifdef WIN32
...
//***************************************************************************
CString
SECFileSystem::GetFileName(const CString& PathAndFileName)
{
...
//***************************************************************************
CString
SECFileSystem::GetPath(const CString& PathAndFileName, const BOOL bIncludeFileSystem /* = TRUE */)
{
...
//***************************************************************************
CString
SECFileSystem::GetExtension(const CString& PathAndFileName)
{
  // Find the last "." in the string and return everything after it.
...
//***************************************************************************
CString
SECFileSystem::GetFileSystem(const CString& PathAndFileName)
{
  CString FileSystem;
...
//***************************************************************************
CString
SECFileSystem::GetBaseFileName(const CString& PathAndFileName)
{
...
//***************************************************************************
BOOL
SECFileSystem::FileExists(const CString& PathAndFileName)
{
  CFileStatus FileStatus;
...
//***************************************************************************
BOOL
SECFileSystem::FileSystemExists(const CString& FileSystemName)
{
...
//***************************************************************************
BOOL
SECFileSystem::DirectoryExists(const CString& Path)
{
#ifdef WIN32
...
//***************************************************************************
CStringList  *
SECFileSystem::GetDirectory(const CString& SearchString, const unsigned long eFileAttrib, const BOOL bRecurseSubDirs /* = FALSE */, CStringList *pStringList /* = NULL */)
{
...
//***************************************************************************
CStringList *
SECFileSystem::GetSubdirList(const CString& SearchDir, const BOOL bPathInName /* = TRUE */)
{
  CFileStatus FileStatus;
...
//***************************************************************************
CStringList *
SECFileSystem::GetFileList(const CString& SearchString, const unsigned long eFileAttrib)
{
  CStringList *pDirList = new CStringList();
...
//***************************************************************************
CString
SECFileSystem::AppendWildcard(const CString& Path, const CString& Wildcard)
{
...
CString SECFileSystem::GetRelPath(CString base, CString path)
{
	// check drives
	if (path.GetLength() == 0 || base.GetLength() == 0) return path;

	if( base[0] != path[0])	return path;

	// remove starting paths
	while(true)
	{
		if(base.GetLength() == 0)	break;
		if(path.GetLength() == 0)	break;

		int st1=0, st2=0;
		if((st1=path.Find("\\")) == -1)	break;
		if((st2=base.Find("\\")) == -1)	break;
		if( st2 != st1)	break;

		base = base.Right(base.GetLength() - st2 - 1);
		path = path.Right(path.GetLength() - st1 - 1);
	}
	...
	{
		int st=0;
		if((st=base.Find("\\")) == -1)	break;
		base = base.Right(base.GetLength() - st - 1);
		path = "..\\" + path;
	}
...
CString SECFileSystem::AppendPaths(CString Path1, CString Path2)
{
	int nLength = Path1.GetLength();
	if (nLength != 0  &&  ((CString)Path1).GetAt(nLength - 1) == '\\')
	...
	while( Path1 != "")
	{
		...
		{
			int i;
			if( (i=Path1.ReverseFind('\\')) == -1)	assert(false);
			Path1 = Path1.Left(i);
			i = Path2.Find("\\");
			Path2 = Path2.Right(Path2.GetLength()-i-1);
		}else
			break;
	}
