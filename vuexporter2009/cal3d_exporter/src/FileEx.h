...
class CFileEx
{
	public:
		CFileEx();
		~CFileEx();
		LPVOID		get_file_data(Cal3DComString fname, LPVOID* data, DWORD* size);
		LPVOID		get_file_data(LPVOID *data, DWORD* size);
		LPVOID		get_file_data(const Cal3DComString& fname, LPVOID* data, DWORD* size);
