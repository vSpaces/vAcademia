...
bool CalCoreModel::create(const Cal3DComString& strName)
{
  //m_strName = strName;
...
{
#pragma warning ("Fix commented [destroy all core materials] in CalCoreModel::destroy()")
	OutputDebugString("1\n");
...
{
	// get the id of the core animation
	for(int i=0; i < m_vectorCoreAnimation.size(); i++)
