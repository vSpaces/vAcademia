...
BVHParser::BVHParser( void *apData, DWORD adwSize, ArticulatedFigure &inFigure, bool &outOK ) : mArticulatedFigure( inFigure )
{
	if( adwSize > 0)
	{
		buffer = (char*)malloc( adwSize);
