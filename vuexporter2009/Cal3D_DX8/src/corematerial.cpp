...
Cal3DComString CalCoreMaterial::getMapFilename(int mapId)
{
  ...
  if((mapId < 0) || (mapId >= (int)m_vectorMap.size()))
  {
	...
	Cal3DComString ret = m_vectorMap[mapId].strFilename;
	{
		Cal3DComString ret2 = m_vectorMap[mapId].strFilename;
	}
  return ret;
}
