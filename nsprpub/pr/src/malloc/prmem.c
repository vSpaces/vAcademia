...
#include "primpl.h"
#include "../../../nmemoryprofiler/MemoryProfilerForPureC.h"
...
PR_IMPLEMENT(void *) PR_Malloc(PRUint32 size)
{
	...
	return GetMemory(size, 35, __FILE__, __LINE__, __FUNCTION__);
}
...
PR_IMPLEMENT(void *) PR_Calloc(PRUint32 nelem, PRUint32 elsize)
{
	...
	return GetZeroMemory(size, 35, __FILE__, __LINE__, __FUNCTION__);
}
...
PR_IMPLEMENT(void *) PR_Realloc(void *ptr, PRUint32 size)
{
	...
	return ReallocMemory(ptr, size, 35, __FILE__, __LINE__, __FUNCTION__);
...
PR_IMPLEMENT(void) PR_Free(void *ptr)
{
   /* if (use_zone_allocator)
        ...
        free(ptr);*/
	FreeMemory(ptr, 35, __FILE__, __LINE__, __FUNCTION__);
}
...
#endif
	*/
	void* ptr = GetZeroMemory(nelem * elsize, 35, __FILE__, __LINE__, __FUNCTION__);	
	return ptr;
}
...
#endif
	*/
	if (ptr) FreeMemory(ptr, 35, __FILE__, __LINE__, __FUNCTION__);
}
