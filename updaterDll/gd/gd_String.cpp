...
#include "stdafx.h" // for precompile heades only
      ...
      else
      {
         ...
         case L'%' :
            *pszBuffer = L'%';
            ...
            break;
         case L'd' :
            _itow( va_arg( arguments, int ), pszBuffer, 10 );
            if( psz != NULL )
            {
...
//#endif
         ...
         case L'I' :
            ...
            {
               _i64tow( va_arg( arguments, __int64 ), pszBuffer, 10 );
               if( psz != NULL )
               {
                  uLength = wcslen( psz ) + 1;
               }
