 ...
 *
 * (C) 2002-2003 Joaquín M López Muñoz (joaquin@tid.es). All rights reserved.
 *
 ...
 *       "Portions copyright 2002-2003 Joaquín M López Muñoz (joaquin@tid.es)"
 *
...
public:
  ...
  public:
    ...
    /* assigning a from object is the same as assigning its owner */

    from& operator=(const from& r)
    {
    ...
    bool operator==(const from& r)const
    {
  ...
  public:
    ...
    bool operator==(const to& r)const
    {
      return size()==r.size()&&std::equal(begin(),end(),r.begin());
    }
...
class bimap:
  public 
    bimap_detail::select<
      bimap_detail::equal_types<from_type,to_type>::value,
      bimap_equal_types<
        from_type,to_type,
...
public:
  ...
  typedef 
    bimap<
      ...
      std::allocator<direct_pair<const to_type,const from_type> > >
    inv_bimap;
  ...
  typedef 
    bimap<
      ...
      typename allocator_type::template rebind<
        direct_pair<const to_type,const from_type> >::other>
    inv_bimap;
...
#elif VERSION_BIMAP_9B698EF9_C6E9_4BC4_A7D2_5B4D71155761!=0x00010001
