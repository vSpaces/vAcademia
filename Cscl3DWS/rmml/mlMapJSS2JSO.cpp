...
mlMapJSS2JSO::_Nodeptr mlMapJSS2JSO::_Nil=NULL;
size_t mlMapJSS2JSO::_Nilrefs=0;

void mlMapJSS2JSO::_Init(){
	if (_Nil == 0){
...
void mlMapJSS2JSO::_Lrotate(_Nodeptr _X){
...
void mlMapJSS2JSO::_Rrotate(_Nodeptr _X){
...
mlMapJSS2JSO::iterator mlMapJSS2JSO::_Insert(_Nodeptr _X, _Nodeptr _Y, const value_type& _V)
{
...
mlMapJSS2JSO::iterator mlMapJSS2JSO::_erase_(iterator _P){
    _Nodeptr _X;
...
void mlMapJSS2JSO::_Erase(_Nodeptr _X){
...
mlMapJSS2JSO::iterator mlMapJSS2JSO::_erase_(iterator _F, iterator _L){
...
mlMapJSS2JSO::size_type mlMapJSS2JSO::_count_(const _K& _Kv) const{
...
mlMapJSS2JSO::size_type mlMapJSS2JSO::_erase_(const _K& _X){
