...
///////////////////////////////////////////////////////////////////////////////
// GetWinVer
BOOL GetWinVer(LPTSTR pszVersion, int *nVersion, LPTSTR pszMajorMinorBuild, LPTSTR pszMajorMinorServicePack)
{
	...
	*nVersion = WUNKNOWN;
	...
	if (!GetVersionEx( (POSVERSIONINFO)&osinfo))
		return FALSE;
	...
	DWORD dwServicePackMajor = osinfo.wServicePackMajor;
	DWORD dwServicePackMinor = osinfo.wServicePackMinor;	

	wsprintf(pszMajorMinorBuild, _T("%u.%u.%u"), dwMajorVersion, dwMinorVersion, dwBuildNumber);
	wsprintf(pszMajorMinorServicePack, _T("%u.%u"), dwServicePackMajor, dwServicePackMinor);
