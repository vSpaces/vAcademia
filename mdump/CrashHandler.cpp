...
LONG CCrashHandler::CreateMiniDump(EXCEPTION_POINTERS* pExcPtrs)
{  	
...
void CCrashHandler::UnexpectedHandler()
{
	CoInitialize(NULL);
...
int CCrashHandler::NewHandler(size_t)
{
	CoInitialize(NULL);
...
void CCrashHandler::TerminateMyProcess(UINT uExitCode)
{
