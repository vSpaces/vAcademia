...
/*void CalCoreKeyframe::setParentKeyFrame(CalCoreKeyframe* pKeyframe)
{
	m_parentBoneKeyframe = pKeyframe;
}

CalCoreKeyframe* CalCoreKeyframe::getParentKeyFrame()
{
	return m_parentBoneKeyframe;
}

void CalCoreKeyframe::setCurrentPosition(CalVector currentPos)
{
	m_currentPos = currentPos;
}

const CalVector& CalCoreKeyframe::getCurrentPosition()
{
	return m_currentPos;
}m_matrix

void CalCoreKeyframe::setMatrix(D3DXMATRIX& mat)
{
	m_matrix = mat;
}

D3DXMATRIX CalCoreKeyframe::getMatrix()
{
	return m_matrix;
}*/
