...
public:
	...
	FACEFILEDESC	header;
	//исходные данные
	MP_VECTOR<WORD>	wIndexes;	//номера вершин для движения( в максовой сцене)
	MP_VECTOR<D3DXVECTOR3>	wDeltas;	//коэффициенты векторного произведения

	//вектора соответствия номеров вершин
	MP_VECTOR<WORD>	aMaxIndexes;	//коэффициенты векторного произведения
	MP_VECTOR<WORD>	aCalIndexes;	//коэффициенты векторного произведения
	MP_VECTOR<WORD>	aSubMeshes;	//номера SubMesh
...
public:
	...
	//вектора соответствия номеров вершин
	MP_VECTOR<WORD>	aSubmeshNum;	//номера SubMesh
	MP_VECTOR<WORD>	aVertNum;		//число вершин
	MP_VECTOR<WORD*>	aVertIndexes;	//номера вершин
	MP_VECTOR<D3DXVECTOR3*>	aDeltas;	//коэффициенты векторного произведения
};
//}
