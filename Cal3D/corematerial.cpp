...
CalCoreMaterial::_Map::_Map():
	MP_STRING_INIT(strFilename)
{ 
	type=1;
}

CalCoreMaterial::_Map::_Map(const _Map& m):
	MP_STRING_INIT(strFilename)
{
	*this=m;
}
...
CalCoreMaterial::CalCoreMaterial():
	MP_VECTOR_INIT(m_vectorMap),
	MP_STRING_INIT(m_shaderPath)
{
  m_userData = 0;
}
...
/** Returns the emissive color.
  *
  * This function returns the emissive color of the core material instance.
  *
  * @return A reference to the emissive color.
  *****************************************************************************/
CalCoreMaterial::Color& CalCoreMaterial::getEmissiveColor()
{
...
void CalCoreMaterial::setEmissiveColor(const CalCoreMaterial::Color& emissiveColor)
{
...
CalCoreMaterial*	CalCoreMaterial::clone()
{
	CalCoreMaterial* coreMaterial = MP_NEW( CalCoreMaterial);
	*coreMaterial = *this;
	return coreMaterial;
}

void CalCoreMaterial::setShaderPath(LPCTSTR alpShaderPath)
{
	assert( alpShaderPath);
	if( alpShaderPath)
		m_shaderPath = alpShaderPath;
	else
		m_shaderPath = "";
}

LPCTSTR CalCoreMaterial::getShaderPath()
{
