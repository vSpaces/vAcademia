...
void CalAnimationAction::release()
{
	MP_DELETE_THIS;
}
...
float CalAnimationAction::getDelayIn()const
{
	return m_delayIn;
}

float CalAnimationAction::getDelayOut()const
{
	return m_delayOut;
}

float CalAnimationAction::getDelayTarget()const
{
	return m_delayTarget;
}
